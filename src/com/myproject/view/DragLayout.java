...
import cn.readphone.util.GeneralUtil;
import cn.readphone.util.GeneralUtil.Size;
...
public class DragLayout extends FrameLayout
{
	...
	public DragLayout(Context context , AttributeSet attrs)
	{
		...
		mszScreen = GeneralUtil.getScreenSize(context);
		mfLeftRange = mszScreen.width * 0.3f;
	}
	...
	class YScrollDetector extends SimpleOnGestureListener
	{
		...
		{
			return e2.getX() < mfLeftRange && Math.abs(dy) <= Math.abs(dx);
		}
	}
